...
avancementtacheRoute.route('/create').post((req, res, next) => {
  ...
  const post = new notification({
    ...
    description: "creation avancementtache par MODELEUR",
...
avancementtacheRoute.route('/update/:id').put((req, res, next) => {
  ...
  const post = new notification({
    ...
    description: "mise a jour avancementtache par MODELEUR",
    datecreation: new Date(),
    etat: "en cours",
  })
  post.save();
...
avancementtacheRoute.route('/delete/:id').delete((req, res, next) => {
  ...
  const post = new notification({
    ...
    description: "suppression avancementtache par MODELEUR",
    datecreation: new Date(),
    etat: "en cours",
  })
  post.save();
