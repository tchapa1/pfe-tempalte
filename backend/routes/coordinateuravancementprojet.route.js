...
avancementprojetRoute.route('/create').post((req, res, next) => {
  ...
  const post = new notification({
    ...
    description: "creation avancementprojet par COORDINATEUR",
...
avancementprojetRoute.route('/update/:id').put((req, res, next) => {
  ...
  const post = new notification({
    ...
    description: "mise a jour avancementprojet par COORDINATEUR",
    datecreation: new Date(),
    etat: "en cours",
  })
  post.save();
...
avancementprojetRoute.route('/delete/:id').delete((req, res, next) => {
  ...
  const post = new notification({
    ...
    description: "suppression avancementprojet par COORDINATEUR",
    datecreation: new Date(),
    etat: "en cours",
  })
  post.save();
