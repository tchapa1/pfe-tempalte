...
@Component({
  selector: 'app-dgeditabsence',
  templateUrl: './dgeditabsence.component.html',
  styleUrls: ['./dgeditabsence.component.css']
})
export class DgeditabsenceComponent implements OnInit {
    ...
    if (!this.editForm.valid) {
      ...
      if (window.confirm('Are you sure?')) {
        ...
        this.apiService.updateAbsence(id, this.editForm.value).subscribe({
          complete: () => {
            this.router.navigateByUrl('/dglistabsence');
