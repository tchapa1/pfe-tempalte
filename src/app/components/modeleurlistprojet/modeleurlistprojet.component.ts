...
@Component({
  selector: 'app-modeleurlistprojet',
  templateUrl: './modeleurlistprojet.component.html',
  styleUrls: ['./modeleurlistprojet.component.css']
})
export class ModeleurlistprojetComponent implements OnInit {
