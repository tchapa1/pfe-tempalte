...
@Component({
  selector: 'app-coordinateuredittache',
  templateUrl: './coordinateuredittache.component.html',
  styleUrls: ['./coordinateuredittache.component.css']
})
export class CoordinateuredittacheComponent implements OnInit {
    ...
    if (!this.editForm.valid) {
      ...
      if (window.confirm('Are you sure?')) {
        ...
        this.apiService.updateTache(id, this.editForm.value).subscribe({
          complete: () => {
            this.router.navigateByUrl('/coordinateurlisttache');
