...
@Component({
  selector: 'app-dglistavancementprojet',
  templateUrl: './dglistavancementprojet.component.html',
  styleUrls: ['./dglistavancementprojet.component.css']
})
export class DglistavancementprojetComponent implements OnInit {
