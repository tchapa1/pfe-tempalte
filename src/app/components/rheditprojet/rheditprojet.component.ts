...
@Component({
  selector: 'app-rheditprojet',
  templateUrl: './rheditprojet.component.html',
  styleUrls: ['./rheditprojet.component.css']
})
export class RheditprojetComponent implements OnInit {
    ...
    if (!this.editForm.valid) {
      ...
      if (window.confirm('Are you sure?')) {
        ...
        this.apiService.updateProjet(id, this.editForm.value).subscribe({
          complete: () => {
            this.router.navigateByUrl('/rhlistprojet');
