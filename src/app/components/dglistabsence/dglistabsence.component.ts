...
@Component({
  selector: 'app-dglistabsence',
  templateUrl: './dglistabsence.component.html',
  styleUrls: ['./dglistabsence.component.css']
})
export class DglistabsenceComponent implements OnInit {
