...
@Component({
  selector: 'app-coordinateureditconge',
  templateUrl: './coordinateureditconge.component.html',
  styleUrls: ['./coordinateureditconge.component.css']
})
export class CoordinateureditcongeComponent implements OnInit {
    ...
    if (!this.editForm.valid) {
      ...
      if (window.confirm('Are you sure?')) {
        ...
        this.apiService.updateConge(id, this.editForm.value).subscribe({
          complete: () => {
            this.router.navigateByUrl('/coordinateurlistconge');
