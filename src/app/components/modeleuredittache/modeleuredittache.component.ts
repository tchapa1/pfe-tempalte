...
@Component({
  selector: 'app-modeleuredittache',
  templateUrl: './modeleuredittache.component.html',
  styleUrls: ['./modeleuredittache.component.css']
})
export class ModeleuredittacheComponent implements OnInit {
    ...
    if (!this.editForm.valid) {
      ...
      if (window.confirm('Are you sure?')) {
        ...
        this.apiService.updateTache(id, this.editForm.value).subscribe({
          complete: () => {
            this.router.navigateByUrl('/modeleurlisttache');
