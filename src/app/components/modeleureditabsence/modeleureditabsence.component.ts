...
@Component({
  selector: 'app-modeleureditabsence',
  templateUrl: './modeleureditabsence.component.html',
  styleUrls: ['./modeleureditabsence.component.css']
})
export class ModeleureditabsenceComponent implements OnInit {
    ...
    if (!this.editForm.valid) {
      ...
      if (window.confirm('Are you sure?')) {
        ...
        this.apiService.updateAbsence(id, this.editForm.value).subscribe({
          complete: () => {
            this.router.navigateByUrl('/modeleurlistabsence');
