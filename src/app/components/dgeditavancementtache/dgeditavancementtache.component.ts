...
@Component({
  selector: 'app-dgeditavancementtache',
  templateUrl: './dgeditavancementtache.component.html',
  styleUrls: ['./dgeditavancementtache.component.css']
})
export class DgeditavancementtacheComponent implements OnInit {
    ...
    if (!this.editForm.valid) {
      ...
      if (window.confirm('Are you sure?')) {
        ...
        this.apiService.updateAvancementtache(id, this.editForm.value).subscribe({
          complete: () => {
            this.router.navigateByUrl('/dglistavancementtache');
