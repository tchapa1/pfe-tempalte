...
@Component({
  selector: 'app-coordinateureditabsence',
  templateUrl: './coordinateureditabsence.component.html',
  styleUrls: ['./coordinateureditabsence.component.css']
})
export class CoordinateureditabsenceComponent implements OnInit {
    ...
    if (!this.editForm.valid) {
      ...
      if (window.confirm('Are you sure?')) {
        ...
        this.apiService.updateAbsence(id, this.editForm.value).subscribe({
          complete: () => {
            this.router.navigateByUrl('/coordinateurlistabsence');
