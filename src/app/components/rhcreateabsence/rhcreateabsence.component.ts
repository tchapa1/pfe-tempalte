...
@Component({
  selector: 'app-rhcreateabsence',
  templateUrl: './rhcreateabsence.component.html',
  styleUrls: ['./rhcreateabsence.component.css']
})
export class RhcreateabsenceComponent implements OnInit {
      ...
      return this.apiService.createAbsence(this.absenceForm.value).subscribe({
        complete: () => {
          console.log('absence successfully created!'),
            this.ngZone.run(() => this.router.navigateByUrl('/rhabsence'));
        },
        error: (e) => {
          console.log(e);
        },
