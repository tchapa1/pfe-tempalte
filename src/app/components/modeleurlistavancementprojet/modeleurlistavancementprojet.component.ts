...
@Component({
  selector: 'app-modeleurlistavancementprojet',
  templateUrl: './modeleurlistavancementprojet.component.html',
  styleUrls: ['./modeleurlistavancementprojet.component.css']
})
export class ModeleurlistavancementprojetComponent implements OnInit {
