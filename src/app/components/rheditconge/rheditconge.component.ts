...
@Component({
  selector: 'app-rheditconge',
  templateUrl: './rheditconge.component.html',
  styleUrls: ['./rheditconge.component.css']
})
export class RheditcongeComponent implements OnInit {
    ...
    if (!this.editForm.valid) {
      ...
      if (window.confirm('Are you sure?')) {
        ...
        this.apiService.updateConge(id, this.editForm.value).subscribe({
          complete: () => {
            this.router.navigateByUrl('/rhlistconge');
