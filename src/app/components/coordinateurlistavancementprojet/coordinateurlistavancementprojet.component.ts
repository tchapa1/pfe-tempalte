...
@Component({
  selector: 'app-coordinateurlistavancementprojet',
  templateUrl: './coordinateurlistavancementprojet.component.html',
  styleUrls: ['./coordinateurlistavancementprojet.component.css']
})
export class CoordinateurlistavancementprojetComponent implements OnInit {
