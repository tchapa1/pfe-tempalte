...
@Component({
  selector: 'app-modeleurlistavancementtache',
  templateUrl: './modeleurlistavancementtache.component.html',
  styleUrls: ['./modeleurlistavancementtache.component.css']
})
export class ModeleurlistavancementtacheComponent implements OnInit {
