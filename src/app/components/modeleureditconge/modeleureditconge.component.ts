...
@Component({
  selector: 'app-modeleureditconge',
  templateUrl: './modeleureditconge.component.html',
  styleUrls: ['./modeleureditconge.component.css']
})
export class ModeleureditcongeComponent implements OnInit {
    ...
    if (!this.editForm.valid) {
      ...
      if (window.confirm('Are you sure?')) {
        ...
        this.apiService.updateConge(id, this.editForm.value).subscribe({
          complete: () => {
            this.router.navigateByUrl('/modeleurlistconge');
