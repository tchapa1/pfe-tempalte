...
import { AuthData } from 'src/app/auth/user.model';
  ...
  return this.http
    ...
    .subscribe(response => {
      ...
      if (token) {
        ...
        const pass3 = 'rh';
        const pass4 = 'dg';
        const pass5 = 'coordinateur';
        const pass6 = 'modeleur';
        ...
        {
        this.router.navigate(["/cheflistabsence"]);
        }
        if(this.roleid===pass3)
        {
        this.router.navigate(["/rhlistabsence"]);
        }
        ...
        {
        this.router.navigate(["/coordinateurlistabsence"]);
        }
        if(this.roleid===pass6)
        {
        this.router.navigate(["/modeleurlistabsence"]);
        }
